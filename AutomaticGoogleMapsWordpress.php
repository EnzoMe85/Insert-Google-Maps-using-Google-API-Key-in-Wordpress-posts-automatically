function my_map_shortcode() {
    ...
    $map_url = 'https://www.google.com/maps/embed/v1/place?key=YOUR_API_KEY&q=' . $latitude . ',' . $longitude;

    return '<iframe width="100%" height="450" frameborder="0" style="border:0" src="' . $map_url . '" allowfullscreen></iframe>';
}
